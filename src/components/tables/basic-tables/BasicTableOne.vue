...
const users = ref([
  {
    name: 'Lindsey Curtis',
    role: 'Web Designer',
    avatar: '/project_yf/images/user/user-17.jpg',
    project: 'Agency Website',
    team: ['/project_yf/images/user/user-22.jpg', '/project_yf/images/user/user-23.jpg', '/project_yf/images/user/user-24.jpg'],
    status: 'Active',
    budget: '3.9K',
  },
  {
    ...
    avatar: '/project_yf/images/user/user-18.jpg',
    project: 'Technology',
    team: ['/project_yf/images/user/user-25.jpg', '/project_yf/images/user/user-26.jpg'],
    status: 'Pending',
    budget: '24.9K',
  },
  {
    name: 'Zain Geidt',
    role: 'Content Writer',
    avatar: '/project_yf/images/user/user-19.jpg',
    project: 'Blog Writing',
    team: ['/project_yf/images/user/user-27.jpg'],
    status: 'Active',
    budget: '12.7K',
  },
  {
    ...
    avatar: '/project_yf/images/user/user-20.jpg',
    project: 'Social Media',
    team: ['/project_yf/images/user/user-28.jpg', '/project_yf/images/user/user-29.jpg', '/project_yf/images/user/user-30.jpg'],
    status: 'Cancel',
    budget: '2.8K',
  },
  {
    ...
    avatar: '/project_yf/images/user/user-21.jpg',
    project: 'Website',
    team: ['/project_yf/images/user/user-31.jpg', '/project_yf/images/user/user-32.jpg', '/project_yf/images/user/user-33.jpg'],
    status: 'Active',
    budget: '4.5K',
  },
])
